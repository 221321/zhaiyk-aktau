...
async function shareDebtReminder(d) {
  ...
  try {
    ...
    // Временная диагностика — помогает выяснить, почему на некоторых
    // телефонах "Поделиться" с файлом падает молча (например, разрешение
    // браузера на share истекает, если fetch фото занял слишком много
    // времени после тапа). Без этого на устройстве просто виден откат к
    // wa.me + отдельной вкладке, без объяснения причины.
    alert('Не удалось поделиться файлом напрямую (' + (e && e.name + ': ' + e.message || e) + '), открываю обычным способом.');
  }
  openFallback();
}
...
function DebtsPanel({
  ...
  const sendReminder = async d => {
    ...
    if (window.confirm(`Отправили сообщение в WhatsApp должнику «${d.client_name}»?`)) {
      try {
        await apiCall('POST', '/api/debt-reminders', {
...
function ReturnFormModal({
    ...
    try {
      ...
      if (mode === "order") {
        ...
        payload = {
          ...
          refundDebt: Number(refundDebt) || 0
        };
      } else {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      display: "grid",
      gridTemplateColumns: mode === "order" && selectedOrder && selectedOrder.payment_debt > 0 ? "1fr 1fr 1fr" : "1fr 1fr",
      gap: 8,
      marginTop: 10
    }
  ...
  })), mode === "order" && selectedOrder && selectedOrder.payment_debt > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: S.label
  }, "\u0421\u043F\u0438\u0441\u0430\u0442\u044C \u0434\u043E\u043B\u0433\u043E\u043C, \u20B8"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    style: S.input,
    placeholder: "0",
    value: refundDebt,
    onChange: e => setRefundDebt(e.target.value)
  }))), mode === "order" && selectedOrder && selectedOrder.payment_debt > 0 && /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "6px 0 0",
      fontSize: 13,
      color: C.textFaint
    }
  }, "\u0422\u043E\u0432\u0430\u0440 \u043F\u0440\u043E\u0434\u0430\u043D \u0432 \u0434\u043E\u043B\u0433 \u2014 \u0432\u043C\u0435\u0441\u0442\u043E \u0432\u043E\u0437\u0432\u0440\u0430\u0442\u0430 \u0434\u0435\u043D\u0435\u0433 \u043C\u043E\u0436\u043D\u043E \u043F\u0440\u043E\u0441\u0442\u043E \u0443\u043C\u0435\u043D\u044C\u0448\u0438\u0442\u044C \u0434\u043E\u043B\u0433 \u043A\u043B\u0438\u0435\u043D\u0442\u0430 \u043D\u0430 \u0441\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u0432\u043E\u0437\u0432\u0440\u0430\u0449\u0451\u043D\u043D\u043E\u0433\u043E."), error && /*#__PURE__*/React.createElement("p", {
    style: {
      ...S.errorBox,
      marginTop: 12,
      marginBottom: 0
...
async function downloadOrderWaybillXlsx(order, isDogovornik, productNameByCode) {
  ...
  if (isDogovornik) buildDogovornikWaybillSheet(ws, order, productNameByCode);else buildSimpleWaybillSheet(ws, order, productNameByCode);
  ...
  const a = document.createElement('a');
  a.href = url;
  a.download = `nakladnaya_${order.id}.xlsx`;
...
function OrderDetail({
  ...
  const exportOrderXlsx = async () => {
    ...
    try {
      await downloadOrderWaybillXlsx(order, isDogovornik, productNameByCode);
    } catch (e) {
      alert('Не получилось сформировать Excel: ' + e.message);
    }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      fontSize: 15,
      fontWeight: 700,
      cursor: pendingWeightItems.length > 0 ? "not-allowed" : "pointer",
      opacity: pendingWeightItems.length > 0 ? 0.5 : 1,
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
      gap: 6
    ...
    style: {
      ...
      padding: "9px",
      fontSize: 14,
      opacity: exportingXlsx ? 0.6 : 1,
      cursor: exportingXlsx ? "wait" : "pointer"
    },
    onClick: exportOrderXlsx
  }, exportingXlsx ? "Формирую..." : "⬇ Скачать накладную в Excel"), /*#__PURE__*/React.createElement("hr", {
    style: S.divider
  ...
  fixingQtyIndex === i ? /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83D\uDE9A \u0412\u0437\u044F\u0442\u044C \u0432 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0443")), canWarehousePickup && order.status === "new" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20
    }
  }, /*#__PURE__*/React.createElement("button", {
    style: S.btnPrimary,
    onClick: () => onUpdateStatus(order.id, "in_transit", null)
  }, "\uD83D\uDCE6 \u0412\u044B\u0434\u0430\u0442\u044C \u0441\u043E \u0441\u043A\u043B\u0430\u0434\u0430")), (currentUser.role === "sales" || currentUser.role === "store" || currentUser.role === "senior_sales" && order.sales_id === currentUser.id) && order.status === "new" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20
    }
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, e.kind === "price" ? "💰 " : "", e.by_name, " \xB7 ", fmtDT(e.at)), /*#__PURE__*/React.createElement("div", null, "\u0421\u0443\u043C\u043C\u0430: ", (e.before_total || 0).toLocaleString(), " \u20B8 \u2192 ", (e.after_total || 0).toLocaleString(), " \u20B8"), e.reason && /*#__PURE__*/React.createElement("div", null, "\u041F\u0440\u0438\u0447\u0438\u043D\u0430: ", e.reason)))), currentUser.role === "admin" && onAnnulOrder && order.status === "delivered" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      paddingTop: 16,
      borderTop: `1px dashed ${C.border}`
    }
  }, !annulling ? /*#__PURE__*/React.createElement("button", {
    style: {
      ...S.btnDanger,
      width: "100%"
    },
  ...
  }, "\u26D4 \u0410\u043D\u043D\u0443\u043B\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443") : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 8px",
      fontSize: 15,
      fontWeight: 700,
  ...
  }, "\u0410\u043D\u043D\u0443\u043B\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 \u2116 ", order.id), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 10px",
      fontSize: 13,
      color: C.textFaint
    }
  }, "\u0417\u0430\u044F\u0432\u043A\u0430 \u0446\u0435\u043B\u0438\u043A\u043E\u043C \u043E\u0442\u043C\u0435\u043D\u044F\u0435\u0442\u0441\u044F, \u043A\u0430\u043A \u0431\u0443\u0434\u0442\u043E \u0435\u0451 \u043D\u0435 \u0431\u044B\u043B\u043E: \u0432\u0435\u0441\u044C \u043E\u0441\u0442\u0430\u0442\u043E\u043A \u0432\u0435\u0440\u043D\u0451\u0442\u0441\u044F \u043D\u0430 \u0441\u043A\u043B\u0430\u0434, \u0434\u043E\u043B\u0433/\u043A\u0430\u0441\u0441\u0430 \u0438 \u0431\u043E\u043D\u0443\u0441 \u0442\u043E\u0440\u0433\u043E\u0432\u043E\u0433\u043E \u043F\u043E \u043D\u0435\u0439 \u043E\u0431\u043D\u0443\u043B\u044F\u0442\u0441\u044F. \u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u043D\u0435\u043B\u044C\u0437\u044F \u043E\u0442\u043C\u0435\u043D\u0438\u0442\u044C."), /*#__PURE__*/React.createElement("input", {
    style: {
      ...S.input,
      marginBottom: 10
    },
    ...
    disabled: savingAnnul,
    style: {
      ...S.btnDanger,
      flex: 1,
      marginTop: 0,
      opacity: savingAnnul ? 0.5 : 1
    },
    onClick: saveAnnul
  }, savingAnnul ? "Аннулирование..." : "Аннулировать"), /*#__PURE__*/React.createElement("button", {
    disabled: savingAnnul,
    style: {
      ...S.btnSecondary,
      flex: 1
  ...
  }, "\u041E\u0442\u043C\u0435\u043D\u0430")))), order.status === "annulled" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      paddingTop: 16,
      borderTop: `1px dashed ${C.border}`
    ...
    style: {
      padding: "10px 12px",
      borderRadius: 10,
      background: SB.annulled,
      border: `1px solid ${SC.annulled}`,
      fontSize: 13,
      color: C.text
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u26D4 \u0417\u0430\u044F\u0432\u043A\u0430 \u0430\u043D\u043D\u0443\u043B\u0438\u0440\u043E\u0432\u0430\u043D\u0430"), order.annulled_by_name && /*#__PURE__*/React.createElement("div", null, order.annulled_by_name, order.annulled_at ? ` · ${fmtDT(order.annulled_at)}` : ""), order.annul_reason && /*#__PURE__*/React.createElement("div", null, "\u041F\u0440\u0438\u0447\u0438\u043D\u0430: ", order.annul_reason))), currentUser.role === "admin" && onDeleteOrder && order.status !== "delivered" && order.status !== "annulled" && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      paddingTop: 16,
      borderTop: `1px dashed ${C.border}`
...
function SalesCabinet({
  ...
  const updateEditLine = (uid, patch) => setEditLines(ls => ls.map(l => l.uid === uid ? {
    ...l,
    ...patch
  } : l));
  ...
  const handleSaveEdit = async () => {
    ...
    setEditSaving(true);
    try {
      await apiCall('PUT', `/api/orders/${editOrder.id}/items`, {
        items
      });
      closeEditOrder();
      loadOrders();
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u041C\u043E\u0436\u043D\u043E \u0443\u043C\u0435\u043D\u044C\u0448\u0438\u0442\u044C/\u0443\u0431\u0440\u0430\u0442\u044C \u043F\u043E\u0437\u0438\u0446\u0438\u044E \u0438\u043B\u0438 \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043D\u043E\u0432\u0443\u044E \u2014 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u043E, \u043F\u043E\u043A\u0430 \u0437\u0430\u044F\u0432\u043A\u0430 \xAB\u041E\u0436\u0438\u0434\u0430\u0435\u0442\xBB"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 64px 80px 28px",
      gap: 6,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onFocus: () => updateEditLine(line.uid, {
        showDrop: true
      }),
      onBlur: () => setTimeout(() => updateEditLine(line.uid, {
        showDrop: false
      }), 180)
      ...
      return /*#__PURE__*/React.createElement("div", {
        key: p.id,
        onMouseDown: () => selectEditProduct(line.uid, p),
        style: {
          padding: "9px 12px",
      ...
      onClick: () => removeEditLine(line.uid),
      style: {
        width: 28,
        height: 34,
        border: `1px solid ${C.border}`,
      ...
      key: i,
      onClick: () => updateEditLine(line.uid, {
        price: pr
      }),
      style: {
        padding: "5px 12px",
  ...
  }, "+ \u0422\u043E\u0432\u0430\u0440"), filledEditLines.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("hr", {
    style: {
      ...S.divider,
      marginTop: 12
    }
  ...
  }, editTotal.toLocaleString(), " \u20B8"))), /*#__PURE__*/React.createElement("button", {
    style: {
      ...S.btnPrimary,
      opacity: editSaving || filledEditLines.length === 0 || hasEditOverStock ? 0.45 : 1
    },
    disabled: editSaving || filledEditLines.length === 0 || hasEditOverStock,
    onClick: handleSaveEdit
  }, editSaving ? "Сохранение..." : "💾 Сохранить"), /*#__PURE__*/React.createElement("button", {
    style: {
      ...S.btnDanger,
      marginTop: 8
    },
  ...
  }, "\uD83D\uDDD1 \u041E\u0442\u043E\u0437\u0432\u0430\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 \u0446\u0435\u043B\u0438\u043A\u043E\u043C"))), /*#__PURE__*/React.createElement("div", {
    style: S.page
    ...
    onEdit: o.status === "new" && (user.role !== "senior_sales" || o.sales_id === user.id) ? openEditOrder : null
...
function DriverCabinet({
  ...
  const loadMyReturns = useCallback(async () => {
    try {
      setMyReturns(await apiCall('GET', '/api/returns'));
    } catch (e) {}
  }, []);
  useEffect(() => {
    loadMyReturns();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      color: "#7C3AED",
      marginTop: 0,
      marginBottom: myReturns.some(r => r.status === "pending") ? 8 : 14
    }
  }, "\u21A9\uFE0F \u041E\u0444\u043E\u0440\u043C\u0438\u0442\u044C \u0432\u043E\u0437\u0432\u0440\u0430\u0442"), myReturns.filter(r => r.status === "pending").length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 14,
      padding: "9px 12px",
      background: "#FFFBEB",
  ...
  }, "\u23F3 ", myReturns.filter(r => r.status === "pending").length, " ", myReturns.filter(r => r.status === "pending").length === 1 ? 'возврат ждёт' : 'возвратов ждут', " \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u044F \u0441\u043A\u043B\u0430\u0434\u043E\u043C \u2014 \u0442\u043E\u0432\u0430\u0440 \u043F\u0440\u0438\u043C\u0443\u0442 \u0438 \u0437\u0430\u0447\u0442\u0443\u0442 \u0432 \u043E\u0441\u0442\u0430\u0442\u043E\u043A, \u043A\u043E\u0433\u0434\u0430 \u0444\u0438\u0437\u0438\u0447\u0435\u0441\u043A\u0438 \u043F\u0440\u0438\u0432\u0435\u0437\u0451\u0442\u0435."), myActive.length > 0 && /*#__PURE__*/React.createElement("button", {
...
function StockMovementsReport({
  ...
  const exportCsv = () => downloadCsv(`ostatki_dvizhenie_${from}_${to}.csv`, filtered, [{
    ...
    label: 'Кол-во',
    get: r => numLabel(r.qty, r.unit)
  }, {
    label: 'Сумма',
    get: r => r.sum
  }, {
    label: 'Остаток до',
    get: r => r.balance_before == null ? '' : numLabel(r.balance_before, r.unit)
  }, {
    label: 'Списано',
    get: r => r.balance_after == null ? '' : numLabel(r.qty, r.unit)
  }, {
    label: 'Остаток после',
    get: r => r.balance_after == null ? '' : numLabel(r.balance_after, r.unit)
  }]);
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
  ...
  }, "\uD83D\uDCCA \u0414\u0432\u0438\u0436\u0435\u043D\u0438\u0435 \u043E\u0441\u0442\u0430\u0442\u043A\u043E\u0432 \u0438 \u0437\u0430\u044F\u0432\u043A\u0438"), /*#__PURE__*/React.createElement("button", {
    style: S.btnSecondary,
    onClick: onClose
  }, "\u2715")), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "\u0412\u0441\u0435 \u0437\u0430\u044F\u0432\u043A\u0438 \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434 (\u043A\u0440\u043E\u043C\u0435 \u043E\u0442\u043E\u0437\u0432\u0430\u043D\u043D\u044B\u0445) \u2014 \u043A\u043E\u043D\u0442\u0440\u0430\u0433\u0435\u043D\u0442, \u0442\u043E\u0440\u0433\u043E\u0432\u044B\u0439, \u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C, \u0441\u0443\u043C\u043C\u0430. \u0421\u0442\u043E\u043B\u0431\u0446\u044B \"\u041E\u0441\u0442\u0430\u0442\u043E\u043A \u0434\u043E/\u0421\u043F\u0438\u0441\u0430\u043D\u043E/\u041E\u0441\u0442\u0430\u0442\u043E\u043A \u043F\u043E\u0441\u043B\u0435\" \u0437\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u044B \u0442\u043E\u043B\u044C\u043A\u043E \u0443 \u0440\u0435\u0430\u043B\u044C\u043D\u043E \u0434\u043E\u0441\u0442\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0445 \u0437\u0430\u044F\u0432\u043E\u043A \u2014 \u0442\u043E\u043B\u044C\u043A\u043E \u0442\u043E\u0433\u0434\u0430 \u0442\u043E\u0432\u0430\u0440 \u0444\u0438\u0437\u0438\u0447\u0435\u0441\u043A\u0438 \u0441\u043F\u0438\u0441\u0430\u043B\u0441\u044F \u0441\u043E \u0441\u043A\u043B\u0430\u0434\u0430."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexWrap: "wrap",
  ...
  }, "\u0417\u0430 \u044D\u0442\u043E\u0442 \u043F\u0435\u0440\u0438\u043E\u0434 \u0437\u0430\u044F\u0432\u043E\u043A \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E") : /*#__PURE__*/React.createElement("div", {
    style: {
      overflowX: "auto"
    }
  }, /*#__PURE__*/React.createElement("table", {
  ...
  }, "\u041A\u043E\u043D\u0442\u0440\u0430\u0433\u0435\u043D\u0442"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: "6px 8px"
    }
  }, "\u0422\u043E\u0440\u0433\u043E\u0432\u044B\u0439"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: "6px 8px"
    }
  }, "\u0412\u043E\u0434\u0438\u0442\u0435\u043B\u044C"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: "6px 8px"
    }
    ...
    style: {
      background: SB[r.status] || C.surface,
      color: SC[r.status] || C.textSub,
      padding: "2px 8px",
      borderRadius: 20,
      fontSize: 12,
      fontWeight: 700
  ...
  }, r.client_name || '—'), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px"
    }
  }, r.sales_name || '—'), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px"
    }
  }, r.driver_name || '—'), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px"
    }
  }, r.name, /*#__PURE__*/React.createElement("div", {
  ...
  }, numLabel(r.qty, r.unit)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px",
      textAlign: "right",
      whiteSpace: "nowrap"
    }
  }, money(r.sum)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px",
      textAlign: "right"
    }
  }, r.balance_before == null ? '—' : numLabel(r.balance_before, r.unit)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px",
      textAlign: "right",
      fontWeight: 700,
      color: r.balance_after == null ? C.textFaint : C.red
    }
  }, r.balance_after == null ? '—' : `−${numLabel(r.qty, r.unit)}`), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px",
      textAlign: "right",
      fontWeight: 700
    }
  }, r.balance_after == null ? '—' : numLabel(r.balance_after, r.unit)))))))));
}
...
function MaterialStatementReport({
  onClose
}) {
  const todayStr = new Date().toISOString().slice(0, 10);
  const [from, setFrom] = useState(todayStr);
  ...
  }, "\uD83D\uDCCB \u0412\u0435\u0434\u043E\u043C\u043E\u0441\u0442\u044C \u043F\u043E \u0442\u043E\u0432\u0430\u0440\u0443"), /*#__PURE__*/React.createElement("button", {
    style: S.btnSecondary,
    onClick: onClose
  }, "\u2715")), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "\u041D\u0430\u0447\u0430\u043B\u044C\u043D\u044B\u0439 \u043E\u0441\u0442\u0430\u0442\u043E\u043A / \u043F\u0440\u0438\u0445\u043E\u0434 / \u0440\u0430\u0441\u0445\u043E\u0434 / \u043A\u043E\u043D\u0435\u0447\u043D\u044B\u0439 \u043E\u0441\u0442\u0430\u0442\u043E\u043A \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434 \u2014 \u043A\u0430\u043A \u043C\u0430\u0442\u0435\u0440\u0438\u0430\u043B\u044C\u043D\u0430\u044F \u0432\u0435\u0434\u043E\u043C\u043E\u0441\u0442\u044C \u0432 1\u0421, \u0431\u0435\u0437 \u043A\u043E\u043D\u0442\u0440\u0430\u0433\u0435\u043D\u0442\u043E\u0432 \u0438 \u0442\u043E\u0440\u0433\u043E\u0432\u044B\u0445. \u041A\u043E\u043F\u0438\u0442\u0441\u044F \u0441 \u043C\u043E\u043C\u0435\u043D\u0442\u0430, \u043A\u0430\u043A \u044D\u0442\u0443 \u043B\u0435\u043D\u0442\u0443 \u0437\u0430\u0432\u0435\u043B\u0438 \u043D\u0430 \u0441\u0430\u0439\u0442\u0435 \u2014 \u0437\u0430 \u0431\u043E\u043B\u0435\u0435 \u0440\u0430\u043D\u043D\u0438\u0435 \u043F\u0435\u0440\u0438\u043E\u0434\u044B \u043F\u0440\u0438\u0445\u043E\u0434/\u0440\u0430\u0441\u0445\u043E\u0434 \u0431\u0443\u0434\u0443\u0442 \u043D\u0443\u043B\u044F\u043C\u0438 (\u0432\u0438\u0434\u0435\u043D \u0442\u043E\u043B\u044C\u043A\u043E \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u043E\u0441\u0442\u0430\u0442\u043E\u043A)."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexWrap: "wrap",
  ...
  }), "\u0421\u043A\u0440\u044B\u0442\u044C \u0431\u0435\u0437 \u0434\u0432\u0438\u0436\u0435\u043D\u0438\u044F")), /*#__PURE__*/React.createElement("div", {
    style: {
      ...S.row,
      marginBottom: 10
    }
  ...
  }, "\u041D\u0430\u0447\u0430\u043B\u044C\u043D\u044B\u0439 \u043E\u0441\u0442\u0430\u0442\u043E\u043A"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: "6px 8px",
      textAlign: "right"
    }
  ...
  }, numLabel(r.opening, r.unit)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px",
      textAlign: "right",
      color: C.green,
  ...
  }, r.income ? `+${numLabel(r.income, r.unit)}` : numLabel(0, r.unit)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "6px 8px",
      textAlign: "right",
      color: C.red,
...
function StockPanel() {
  ...
  }, "\uD83D\uDCCA \u041E\u0442\u0447\u0451\u0442 \u043F\u043E \u0434\u0432\u0438\u0436\u0435\u043D\u0438\u044E"), /*#__PURE__*/React.createElement("button", {
    style: {
      ...S.btnOutline,
      width: "auto",
      padding: "6px 12px",
...
function AdminCabinet({
  ...
  const annulOrder = async (orderId, reason) => {
    const res = await apiCall('PUT', `/api/orders/${orderId}/annul`, {
      reason
    });
    setSelectedOrder(res);
    loadOrders();
  ...
  const {
    ...
    debtSettlements.forEach(s => {
      ...
      if (s.method === 'qr') bucket[key].qr += s.amount;else if (s.method !== 'return') bucket[key].cash += s.amount;
    ...
    returnsList.forEach(r => {
      ...
      if (!refundedByOrder[r.order_id]) refundedByOrder[r.order_id] = {
        cash: 0,
        qr: 0
      };
  ...
  const content = /*#__PURE__*/React.createElement(React.Fragment, null, tab === "all" && /*#__PURE__*/React.createElement(React.Fragment, null, !desktop && /*#__PURE__*/React.createElement("p", {
  ...
  }, r.items.map(it => `${it.name} × ${it.qty}`).join(', '), r.sales_name ? ` · торговый: ${r.sales_name}` : ' · без торгового', r.reason ? ` · причина: ${r.reason}` : '', " · ", r.status === "confirmed" ? /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.green,
      fontWeight: 600
    }
  }, "\u2713 \u043F\u0440\u0438\u043D\u044F\u0442 \u0441\u043A\u043B\u0430\u0434\u043E\u043C") : /*#__PURE__*/React.createElement("span", {
    style: {
      color: "#92400E",
      fontWeight: 600
    }
  }, "\u23F3 \u0436\u0434\u0451\u0442 \u0441\u043A\u043B\u0430\u0434")))))))), /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: desktop ? 560 : "none"
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    }, receiptLineTotal(line).toLocaleString()), /*#__PURE__*/React.createElement("button", {
  ...
  }), receiptGrandTotal > 0 && /*#__PURE__*/React.createElement("p", {
    style: {
      textAlign: "right",
      fontSize: 17,
      fontWeight: 800,
...
function WarehouseCabinet({
  ...
  const loadReturns = useCallback(async () => {
    try {
      setReturns(await apiCall('GET', '/api/returns'));
    } catch (e) {}
  ...
  const filteredOrders = orders.filter(o => orderFilter === "all" || o.status === orderFilter).filter(o => !pickupOnly || o.time_slot === PICKUP_SLOT).filter(o => !oq || String(o.id).includes(oq) || (o.client_name || '').toLowerCase().includes(oq) || (o.sales_name || '').toLowerCase().includes(oq));
  const [driverFilter, setDriverFilter] = useState("");
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDFEC \u0422\u043E\u043B\u044C\u043A\u043E \u0441\u0430\u043C\u043E\u0432\u044B\u0432\u043E\u0437")), loadingOrders ? /*#__PURE__*/React.createElement("div", {
    style: S.loadingWrap
  ...
  }, h.comment)))))), tab === "returns" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: S.sectionTitle
  }, "\u0412\u043E\u0437\u0432\u0440\u0430\u0442\u044B \u043E\u0442 \u0432\u043E\u0434\u0438\u0442\u0435\u043B\u0435\u0439"), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 16px",
      fontSize: 13,
      color: C.textFaint
    }
  }, "\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u0435, \u0442\u043E\u043B\u044C\u043A\u043E \u043A\u043E\u0433\u0434\u0430 \u0442\u043E\u0432\u0430\u0440 \u0444\u0438\u0437\u0438\u0447\u0435\u0441\u043A\u0438 \u043F\u0440\u0438\u043D\u044F\u0442 \u2014 \u0434\u043E \u044D\u0442\u043E\u0433\u043E \u043E\u0441\u0442\u0430\u0442\u043E\u043A \u043F\u043E \u043D\u0435\u043C\u0443 \u043D\u0435 \u043F\u043E\u043F\u043E\u043B\u043D\u044F\u0435\u0442\u0441\u044F."), loadingReturns ? /*#__PURE__*/React.createElement("div", {
    style: S.loadingWrap
  }, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...") : /*#__PURE__*/React.createElement(React.Fragment, null, pendingReturns.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "40px 0",
      color: C.textFaint
    }
  }, "\u041E\u0436\u0438\u0434\u0430\u044E\u0449\u0438\u0445 \u0432\u043E\u0437\u0432\u0440\u0430\u0442\u043E\u0432 \u043D\u0435\u0442") : pendingReturns.map(r => /*#__PURE__*/React.createElement("div", {
    key: r.id,
    style: {
      ...S.card,
      background: "#FFFBEB",
    ...
    style: S.cardTitle
  }, r.client_name, r.order_id ? ` · заявка №${r.order_id}` : ''), /*#__PURE__*/React.createElement("p", {
    style: S.cardSub
  }, r.date, " \xB7 \u043E\u0444\u043E\u0440\u043C\u0438\u043B ", r.created_by_name)), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      fontSize: 19,
      fontWeight: 800,
  ...
  }, r.items.map(it => `${it.name} × ${it.qty}`).join(', ')), r.reason && /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "4px 0 0",
      fontSize: 13,
      color: C.textFaint
    }
  }, "\u041F\u0440\u0438\u0447\u0438\u043D\u0430: ", r.reason), /*#__PURE__*/React.createElement("button", {
    onClick: () => confirmReturn(r.id),
    disabled: confirmingReturnId === r.id,
    style: {
      ...S.btnPrimary,
      marginTop: 10,
      opacity: confirmingReturnId === r.id ? 0.6 : 1
    }
  }, confirmingReturnId === r.id ? "Подтверждаю..." : "✓ Принял, подтвердить"))), confirmedReturns.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
      ...S.sectionTitle,
      fontSize: 17,
      marginTop: 20
    }
  }, "\u0418\u0441\u0442\u043E\u0440\u0438\u044F"), confirmedReturns.map(r => /*#__PURE__*/React.createElement("div", {
    key: r.id,
    style: S.card
  }, /*#__PURE__*/React.createElement("div", {
    style: S.row
    ...
    style: S.cardSub
  }, r.date, " \xB7 \u043F\u0440\u0438\u043D\u044F\u043B ", r.confirmed_by_name)), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      fontSize: 17,
      fontWeight: 800,
  ...
  }, "\uD83D\uDDA8 \u041F\u0435\u0447\u0430\u0442\u044C \u043D\u0430\u043A\u043B\u0430\u0434\u043D\u043E\u0439"))))))), selectedOrder && /*#__PURE__*/React.createElement(OrderDetail, {
    order: selectedOrder,
    onClose: () => setSelectedOrder(null),
    onUpdateStatus: handleUpdate,
    currentUser: user,
  ...
  }, pendingHandovers.length), k === "returns" && pendingReturns.length > 0 && /*#__PURE__*/React.createElement("span", {
    style: {
      position: "absolute",
      top: 2,
      right: "22%",
